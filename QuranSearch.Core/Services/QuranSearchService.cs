...
public class QuranSearchService
{
    ...
    public async Task LoadQuranTextAsync(string filePath)
    {
        try
        {
    ...
    public async Task LoadRulesAsync(string filePath)
    {
        try
        {
            ...
            {
                throw new Exception("Rules file is empty");
            }
            ...
            {
                throw new Exception("Failed to deserialize rules file");
            }
            ...
            if (_rules.Count == 0)
            {
                throw new Exception("No rules found in rules file");
            }
        }
        catch (Exception ex)
        {
